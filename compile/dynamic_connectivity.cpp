...
PYBIND11_MODULE(dynamic_connectivity, handle) {
  handle.doc() = "Dynamic Connectivity Module modified by Kerry to exclude boost";

  pybind11::class_<DynamicConnectivity>(handle, "DynamicConnectivity")
    .def(pybind11::init<int64_t>(), pybind11::arg("num_vertices"))
    .def("add_edge", &DynamicConnectivity::AddEdge, pybind11::arg("edge"))
    .def("delete_edge", &DynamicConnectivity::DeleteEdge, pybind11::arg("edge"))
    .def("is_connected", &DynamicConnectivity::IsConnected,
         pybind11::arg("u"), pybind11::arg("v"))
    .def("has_edge", &DynamicConnectivity::HasEdge, pybind11::arg("edge"))
    .def("get_size_of_connected_component",
         &DynamicConnectivity::GetSizeOfConnectedComponent,
         pybind11::arg("v"))
    .def("get_number_of_connected_components",
         &DynamicConnectivity::GetNumberOfConnectedComponents);
}
